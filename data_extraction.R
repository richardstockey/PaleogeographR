...
list <- list.files("~/Scotese_Wright_2018_Maps_1-88_6minX6min_PaleoDEMS_nc")
...
for(file.no in 1:length(list)){
  ...
  map <- list[file.no]
  nc <- open.nc(paste0("~/Scotese_Wright_2018_Maps_1-88_6minX6min_PaleoDEMS_nc/", map))
...
save(file = "~/PaleogeographR/Scotese_6min.Rdata", df_sum)
